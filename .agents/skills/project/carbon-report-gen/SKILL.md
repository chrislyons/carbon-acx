...
This skill enables Codex to automatically generate complete, professional carbon accounting reports by:
...
- Report templates in `.Codex/skills/project/carbon-report-gen/templates/`
