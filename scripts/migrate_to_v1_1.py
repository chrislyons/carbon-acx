...
def migrate_sources() -> int:
        ...
        rows = [
            {
                ...
                "ieee_citation": r.get("description", ""),
                "url": "",
                "year": "",
                "license": "",
            }
    ...
    required = [
        ...
        (
            "SRC.DIMPACT.2021",
            "[2] Carbon Trust and DIMPACT, “The Carbon Impact of Video Streaming,” 2021. Available: https://dimpact.org/resources",
            "https://dimpact.org/resources",
            "2021",
        ),
        (
            "SRC.IESO.2024",
            "[3] Independent Electricity System Operator (IESO), “Emissions and Grid Intensity (Ontario)—Data and Reports,” 2024. Available: https://www.ieso.ca/en/Power-Data/Data-Directory",
    ...
    for sid, cit, url, year in required:
        if sid not in ids:
            rows.append(
                {"source_id": sid, "ieee_citation": cit, "url": url, "year": year, "license": ""}
            )
    ...
    rows = [
        {
            "unit_code": "cup",
            "unit_type": "volume",
            "si_conversion_factor": "0.000236588",
            "notes": "",
        },
        ...
        {
            "unit_code": "participant-hour",
            "unit_type": "participation",
            "si_conversion_factor": "3600",
            "notes": "",
        },
        {
            "unit_code": "1k_tokens",
